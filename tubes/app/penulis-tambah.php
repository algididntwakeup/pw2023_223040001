<?php
	...
	if(!isset($_POST['simpan'])) {
		...
		$id_penulis_tmp = str_pad($id_penulis_tmp, 3, "0", STR_PAD_LEFT); // Menambahkan "0" sampai panjang 3 digit termasuk ID penulis Baru
		$id_penulis_tmp = 'PL' . $id_penulis_tmp; // Menambahkan prefix 'PL' untuk ID penulis Baru
?>
