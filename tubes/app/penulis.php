			...
			<div class="page-content">
				<div class="table-upper">
					<div class="table-upper-left">
						<a href="mainpage.php?p=penulis-tambah" class="btn-success btn-medium">Tambah</a>
					</div>
			...
			?>
				...
				?>
					<tr>
                        ...
                        <td class="text-center">
							<a href="mainpage.php?p=penulis-ubah&id=<?php echo $data['id_penulis']; ?>" class="btn-warning mg-btm-5">Ubah</a>
							<a href="mainpage.php?p=penulis-hapus&id=<?php echo $data['id_penulis']; ?>" class="btn-danger mg-btm-5 confirm">Hapus</a>
						</td>
					</tr>
				<?php
					}
				...
				<div class="table-lower">
					...
					<?php if(!isset($_POST['cari'])) { // disable pagination untuk pencarian ?>
						...
						?>
							<li><a href="mainpage.php?p=penulis&num=<?php echo $i; ?>" <?php echo ($num == $i || ($num == 0 && $i == 1)) ? 'class="active"' : '' ?>><?php echo $i; ?></a></li>
					<?php
							}
						}
					?>
