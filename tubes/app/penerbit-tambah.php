<?php
	...
	if(!isset($_POST['simpan'])) {
		...
		$id_penerbit_tmp = str_pad($id_penerbit_tmp, 3, "0", STR_PAD_LEFT); // Menambahkan "0" sampai panjang 3 digit termasuk ID penerbit Baru
		$id_penerbit_tmp = 'PN' . $id_penerbit_tmp; // Menambahkan prefix 'PL' untuk ID penerbit Baru
?>
...
<?php 
		...
		// mengalihkan halaman
		echo "<meta http-equiv='refresh' content='0; url=mainpage.php?p=penerbit'>";
	}
?>