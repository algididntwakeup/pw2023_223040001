...
if (isset($_POST['login'])) {
  ...
  $queryLogin = "SELECT * FROM users WHERE email = '$email' LIMIT 1";
...
<head>
  ...
  <title>Login &mdash; Unpas Library System</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="assets/img/logo/ULMS.png" alt="Unpas logo" width="250">
            </div>
            ...
            <div class="card card-primary">
              ...
              <?php endif; ?>
                <form method="POST" action="" class="needs-validation" novalidate="">
                  ...
                  <a href="register.php" class="text-decoration-none float-end">
